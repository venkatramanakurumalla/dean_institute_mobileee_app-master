import 'package:dean_institute_mobile_app/pages/thnkyou.dart';
...
class RegistePage2 extends StatefulWidget {
  @override
  _RegistePageState createState() => _RegistePageState();
}

class _RegistePageState extends State<RegistePage2> {
...
String course_id=Get.arguments[1].toString();
...
static TextEditingController longitudeController = new TextEditingController();
 ...
 // country_nameController.text,cityController.text,postalController.text,stateController.text);
                   ...
                   // ),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                               Register( user_id,course_id,card_numberController.text,exp_monthController.text, exp_yearController .text,cvcController.text,van,country_codeController.text,
  country_nameController.text,cityController.text,postalController.text,latitude,longitude,ip,stateController.text);
   ...
   Register( user_id,course_id,card,month,year,cvc,amount,countrycode,countryname,city,postal,latitude,longitude,ip,state) async {
       bool _isLoading = false;
  var errorMsg;
...
String longitude='yes';
 // double ip=1212;
   ...
   // var response = await http.post(Uri.parse('https://deaninstitute.fastrider.co/api/registration'),headers: {"Accept": "application/json"}, body: data);
    ...
    var response = await http.post(Uri.parse('https://deaninstitute.fastrider.co/api/enroll-course/5'),headers: {"Accept": "application/json"}, body: data);
