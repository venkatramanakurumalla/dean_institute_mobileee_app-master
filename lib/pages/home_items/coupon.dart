...
// SharedPreferences sharedPreferences = await SharedPreferences.getInstance();
  ...
  //Uri('https://reqres.in/api/register');
    var response = await http.post(Uri.parse('https://deaninstitute.fastrider.co/api/apply/coupon'), body: data);
...
// var status =prefs.setBool("isLoggedIn", true);
   ...
   //  Get.to(HomePage(),arguments:email);
    ...
    //var  jsonResponse = json.decode(response.body);
     ...
     Get.to(PaymentCheckout(),arguments:[k,coi]);

    }
     else{
    var  r= o-k;
       Get.to(PaymentCheckout(),arguments:[r,coi]);
       
       
       Get.snackbar(
              "discount applied sucessfully",
              "",
...
//prefs.remove('apiToken');
  ...
  Register(couponController.text);
 }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("*If you Have a coupon apply*"),
              SizedBox(),
              TextFormField(
